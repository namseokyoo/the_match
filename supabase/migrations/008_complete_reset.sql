-- ===============================================
-- The Match: Complete Database Reset
-- 모든 기존 테이블 삭제 후 새로 생성
-- ===============================================

-- 기존 테이블들 완전 삭제 (의존성 순서 고려)
...
DROP TABLE IF EXISTS tournament_bracket_slots CASCADE;
